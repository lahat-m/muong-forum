    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
                ...
                {/* Hero Content */}
                <div className="relative z-10 flex flex-col items-center max-w-7xl mx-auto px-6 py-20">
                    {/* Animated Logo/Symbol */}
                    <div className="relative mb-8">
                        <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-green-500 to-blue-500 flex items-center justify-center animate-pulse-slow">
                            <div className="w-16 h-16 md:w-24 md:h-24 rounded-full bg-green-800/30 backdrop-blur-md flex items-center justify-center">
                                {/* M logo */}
                                <span className="text-4xl md:text-5xl font-black text-white">M</span>
                            </div>
                        </div>
                        {/* Orbiting element */}
                        <div className="absolute top-0 left-0 right-0 bottom-0 animate-spin-slow" style={{ animationDuration: '15s' }}>
                            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-green-400 shadow-lg shadow-green-400/50"></div>
                        </div>
                    </div>

                    {/* Main Heading with Animation */}
                    <h1 className="relative text-5xl md:text-7xl lg:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-green-200 to-white animate-gradient-x">
                        Muong Forum
                        <span className="absolute -bottom-4 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-green-400 to-transparent animate-pulse-slow"></span>
                    </h1>
                    ...
                    {/* Descriptive Text */}
                    <p className="mt-6 text-gray-300 max-w-2xl text-center text-lg opacity-0 animate-fade-in-up" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
                        Join our vibrant community dedicated to preserving and celebrating the rich heritage of the Muong people while building a bridge to the future.
                    </p>

                    {/* CTA Buttons */}
                    <div className="mt-10 md:mt-12 flex flex-col sm:flex-row gap-4 items-center opacity-0 animate-fade-in-up" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
                        <button
                            onClick={() => navigate("/auth")}
                            className="relative group px-10 py-4 rounded-full overflow-hidden"
                        >
                            <span className="absolute inset-0 bg-gradient-to-r from-green-500 to-green-600 transition-all duration-300 group-hover:opacity-90"></span>
                            <span className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                <span className="absolute inset-0 bg-gradient-to-r from-green-400 to-blue-500 animate-gradient-x"></span>
                            </span>
                        ...
                        <button
                            ...
                            className="relative group bg-transparent px-8 py-3 rounded-full overflow-hidden border-2 border-white/30 hover:border-white/50 transition-all duration-300"
                        >
                    ...
                    <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center opacity-0 animate-fade-in-up" style={{ animationDelay: '1.2s', animationFillMode: 'forwards' }}>
                        <span className="text-gray-400 text-sm mb-2">Discover Events</span>
                ...
                {/* Decorative Elements */}
                <div className="absolute top-20 left-20 w-64 h-64 bg-green-500 rounded-full mix-blend-multiply filter blur-[80px] opacity-10 animate-pulse-slow"></div>
                <div className="absolute bottom-20 right-20 w-64 h-64 bg-blue-500 rounded-full mix-blend-multiply filter blur-[80px] opacity-10 animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
            </section>
